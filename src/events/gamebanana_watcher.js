...
module.exports = {
    ...
    execute: async (client) => {
        ...
        let NEW_MAPS_CHANNEL_ID = await typeormConnection
            .getRepository('configuration')
            .findOne({ where: { name: 'NEW_MAPS_CHANNEL_ID' } });
        guild.channels.fetch(NEW_MAPS_CHANNEL_ID.value).then((GuildChannel) => {
